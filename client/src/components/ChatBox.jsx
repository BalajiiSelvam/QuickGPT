    ...
    max-md:mt-14 2xl:pr-40'>
      ...
      {mode === 'image' && (
        <label className='inline-flex items-center gap-2 mb-3 text-sm mx-auto'>
          <p className='text-xs'>Pulish Generated Image to Community</p>
          <input type="checkbox" className='cursor-pointer' checked=
          {isPublished} onChange={(e) => {
      ...
      rounded-full w-full max-w-2xl p-3 pl-4 mx-auto flex gap-4 items-center'>
        ...
        <input onChange={(e) => setPromtpt(e.target.value)} value = {prompt} type="text" placeholder='Type your prompt here ... ' className='flex-1
